...
export const ResultStatus = ({ }) => {
    ...
    if (error)
        return <Container pb={4} m="auto" display="flex">
                <Text fontSize="15px" color="gray">Could not retrieve any data.</Text>
            </Container>
    if (fetching)
        return <Container pb={4} m="auto" display="flex">
    ...
    if (search)
        return (
            <Container pb={4}>
                <Text fontSize="15px" color="gray">{found} out of total {total} artefacts match the query.</Text>
            </Container>
        )
}